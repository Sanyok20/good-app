...
export const schools = [
    ...
    { name: "Рівненський ліцей №7", img: "https://photos.wikimapia.org/p/00/07/06/48/20_big.jpg" },
    ...
    { name: "Рівненський ліцей №9", img: "https://photos.wikimapia.org/p/00/07/22/32/19_full.jpg" },
    { name: "Рівненський ліцей №10", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRM3GoOLm2VaE8r2jk2yHkHSUsuqxB5nP-CLA&s" },
    ...
    { name: "Рівненський ліцей №15", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPsSd9IcCwUaLEqAY9MlO5UfLQygjgRNbEmA&s" },
];
...
export default function Schools() {
    ...
    return (
        <div>
            <p>Всього шкіл: {schools.length}</p>
            <p>Показано на сторінці: {currentSchools.length}</p>
            <h1>Школи Рівного</h1>
            <List
                bordered
